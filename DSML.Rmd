...
reservations = reservations %>% mutate(numerated = ifelse(booking_status == "Canceled", 1, 0)) %>% mutate(previous_booking_fixed = ifelse(repeated_guest == 0, 0.5, (no_of_previous_cancellations + no_of_previous_bookings_not_canceled)/2))
